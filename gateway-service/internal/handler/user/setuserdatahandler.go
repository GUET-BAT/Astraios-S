...
func SetUserDataHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserDataRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := user.NewSetUserDataLogic(r.Context(), svcCtx)
		resp, err := l.SetUserData(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
