...
const file_auth_proto_rawDesc = "" +
	...
	"\fJwksResponse\x12\x1d\n" +
	"\x04keys\x18\x01 \x03(\v2\t.auth.JwkR\x04keys2\xf8\x01\n" +
	"\vAuthService\x120\n" +
	...
	"\aGetJwks\x12\x16.google.protobuf.Empty\x1a\x12.auth.JwksResponseBT\n" +
...
var file_auth_proto_goTypes = []any{
	...
	(*Jwk)(nil),                  // 6: auth.Jwk
	(*JwksResponse)(nil),         // 7: auth.JwksResponse
	(*emptypb.Empty)(nil),        // 8: google.protobuf.Empty
}
var file_auth_proto_depIdxs = []int32{
	6, // 0: auth.JwksResponse.keys:type_name -> auth.Jwk
	...
	8, // 4: auth.AuthService.GetJwks:input_type -> google.protobuf.Empty
	...
	7, // 8: auth.AuthService.GetJwks:output_type -> auth.JwksResponse
