...
type LoadConfigResponse struct {
	...
	Config        string                 `protobuf:"bytes,3,opt,name=config,proto3" json:"config,omitempty"`   // 配置内容，通常是JSON格式
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LoadConfigResponse) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *LoadConfigResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *LoadConfigResponse) GetConfig() string {
	if x != nil {
		return x.Config
	}
	return ""
...
var file_common_proto_goTypes = []any{
	(*LoadConfigRequest)(nil),  // 0: common.LoadConfigRequest
	(*LoadConfigResponse)(nil), // 1: common.LoadConfigResponse
}
var file_common_proto_depIdxs = []int32{
	0, // 0: common.CommonService.LoadConfig:input_type -> common.LoadConfigRequest
	1, // 1: common.CommonService.LoadConfig:output_type -> common.LoadConfigResponse
